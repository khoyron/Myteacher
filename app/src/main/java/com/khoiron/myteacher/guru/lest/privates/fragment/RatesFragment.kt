...
import com.khoiron.myteacher.guru.lest.privates.layout.fragmentlayout.RatesFragmentUi
...
class RatesFragment: BaseFragment() {
    override fun layoutFragment(): View {
        return RatesFragmentUi<Fragment>().createView(AnkoContext.create(ctx, this))
    }
