                ...
                linearLayout {
                    ...
                    linearLayout {
                        ...
                        editText {
                            ...
                            id = R.id.etAddress
                            leftPadding = dip(10)
                            hint = resources.getString(R.string.addrees)
                            backgroundColor = resources.getColor(R.color.colorTransparant)
                        }.lparams(width = matchParent, height = dip(45))
                    }.lparams(width = matchParent) {
                        topMargin = dip(7)
                    ...
                    linearLayout {
                        ...
                        editText {
                            ...
                            id = R.id.etZipcode
                            leftPadding = dip(10)
                            hint = resources.getString(R.string.zipcode)
                            backgroundColor = resources.getColor(R.color.colorTransparant)
                        }.lparams(width = matchParent, height = dip(45))
                    }.lparams(width = matchParent) {
                        topMargin = dip(7)
                    ...
                    linearLayout {
                        ...
                        editText {
                            ...
                            id = R.id.etgender
                            leftPadding = dip(10)
                            hint = resources.getString(R.string.gender)
                            backgroundColor = resources.getColor(R.color.colorTransparant)
                        }.lparams(width = matchParent, height = dip(45))
                    }.lparams(width = matchParent) {
                        topMargin = dip(7)
                    ...
                    linearLayout {
                        ...
                        editText {
                            ...
                            id = R.id.etType
                            leftPadding = dip(10)
                            hint = resources.getString(R.string.etType)
                            backgroundColor = resources.getColor(R.color.colorTransparant)
                        }.lparams(width = matchParent, height = dip(45))
                    }.lparams(width = matchParent) {
                        topMargin = dip(7)
